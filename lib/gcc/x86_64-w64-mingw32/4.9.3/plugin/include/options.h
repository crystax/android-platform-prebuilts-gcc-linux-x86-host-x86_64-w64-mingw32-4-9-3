...
enum opt_code
{
  ...
  OPT_fset_stack_executable = 877,           /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1025,      /* -fwritable-relocated-rdata */
  /* OPT_fxref = 1026, */                    /* -fxref */
  /* OPT_fzee = 1027, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1028,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1029,                     /* -fzero-link */
  OPT_g = 1030,                              /* -g */
  OPT_gant = 1031,                           /* -gant */
  OPT_gcoff = 1032,                          /* -gcoff */
  OPT_gdwarf = 1033,                         /* -gdwarf */
  OPT_gdwarf_ = 1034,                        /* -gdwarf- */
  OPT_gen_decls = 1035,                      /* -gen-decls */
  OPT_ggdb = 1036,                           /* -ggdb */
  OPT_ggnu_pubnames = 1037,                  /* -ggnu-pubnames */
  OPT_gnat = 1038,                           /* -gnat */
  OPT_gnatO = 1039,                          /* -gnatO */
  OPT_gno_pubnames = 1040,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1041,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1042,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1043,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1044,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1045,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1046,                   /* -gsplit-dwarf */
  OPT_gstabs = 1047,                         /* -gstabs */
  OPT_gstabs_ = 1048,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1049,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1050,                        /* -gtoggle */
  OPT_gvms = 1051,                           /* -gvms */
  OPT_gxcoff = 1052,                         /* -gxcoff */
  OPT_gxcoff_ = 1053,                        /* -gxcoff+ */
  OPT_h = 1054,                              /* -h */
  OPT_idirafter = 1055,                      /* -idirafter */
  OPT_imacros = 1056,                        /* -imacros */
  OPT_imultiarch = 1057,                     /* -imultiarch */
  OPT_imultilib = 1058,                      /* -imultilib */
  OPT_include = 1059,                        /* -include */
  OPT_iplugindir_ = 1060,                    /* -iplugindir= */
  OPT_iprefix = 1061,                        /* -iprefix */
  OPT_iquote = 1062,                         /* -iquote */
  OPT_isysroot = 1063,                       /* -isysroot */
  OPT_isystem = 1064,                        /* -isystem */
  OPT_iwithprefix = 1065,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1066,              /* -iwithprefixbefore */
  OPT_k8 = 1067,                             /* -k8 */
  OPT_l = 1068,                              /* -l */
  OPT_lang_asm = 1069,                       /* -lang-asm */
  OPT_m128bit_long_double = 1070,            /* -m128bit-long-double */
  OPT_m16 = 1071,                            /* -m16 */
  OPT_m32 = 1072,                            /* -m32 */
  OPT_m3dnow = 1073,                         /* -m3dnow */
  OPT_m3dnowa = 1074,                        /* -m3dnowa */
  OPT_m64 = 1075,                            /* -m64 */
  OPT_m80387 = 1076,                         /* -m80387 */
  OPT_m8bit_idiv = 1077,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1078,             /* -m96bit-long-double */
  OPT_mabi_ = 1079,                          /* -mabi= */
  OPT_mabm = 1080,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1081,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1082,                 /* -maddress-mode= */
  OPT_madx = 1083,                           /* -madx */
  OPT_maes = 1084,                           /* -maes */
  OPT_malign_double = 1085,                  /* -malign-double */
  OPT_malign_functions_ = 1086,              /* -malign-functions= */
  OPT_malign_jumps_ = 1087,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1088,                  /* -malign-loops= */
  OPT_malign_stringops = 1089,               /* -malign-stringops */
  OPT_march_ = 1090,                         /* -march= */
  OPT_masm_ = 1091,                          /* -masm= */
  OPT_mavx = 1092,                           /* -mavx */
  OPT_mavx2 = 1093,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1094,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1095,  /* -mavx256-split-unaligned-store */
  OPT_mavx512cd = 1096,                      /* -mavx512cd */
  OPT_mavx512er = 1097,                      /* -mavx512er */
  OPT_mavx512f = 1098,                       /* -mavx512f */
  OPT_mavx512pf = 1099,                      /* -mavx512pf */
  OPT_mbmi = 1100,                           /* -mbmi */
  OPT_mbmi2 = 1101,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1102,                  /* -mbranch-cost= */
  OPT_mcld = 1103,                           /* -mcld */
  OPT_mcmodel_ = 1104,                       /* -mcmodel= */
  OPT_mconsole = 1105,                       /* -mconsole */
  /* OPT_mcpu_ = 1106, */                    /* -mcpu= */
  OPT_mcrc32 = 1107,                         /* -mcrc32 */
  OPT_mcx16 = 1108,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1109,            /* -mdispatch-scheduler */
  OPT_mdll = 1110,                           /* -mdll */
  OPT_mdump_tune_features = 1111,            /* -mdump-tune-features */
  OPT_mf16c = 1112,                          /* -mf16c */
  OPT_mfancy_math_387 = 1113,                /* -mfancy-math-387 */
  OPT_mfentry = 1114,                        /* -mfentry */
  OPT_mfma = 1115,                           /* -mfma */
  OPT_mfma4 = 1116,                          /* -mfma4 */
  OPT_mforce_drap = 1117,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1118,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1119,                       /* -mfpmath= */
  OPT_mfsgsbase = 1120,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1121, */              /* -mfused-madd */
  OPT_mfxsr = 1122,                          /* -mfxsr */
  OPT_mhard_float = 1123,                    /* -mhard-float */
  OPT_mhle = 1124,                           /* -mhle */
  OPT_mieee_fp = 1125,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1126,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1127,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1128,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1129, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1130,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1131,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1132,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1133,                /* -mlong-double-80 */
  OPT_mlwp = 1134,                           /* -mlwp */
  OPT_mlzcnt = 1135,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1136,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1137,              /* -mmemset-strategy= */
  OPT_mmmx = 1138,                           /* -mmmx */
  OPT_mmovbe = 1139,                         /* -mmovbe */
  OPT_mms_bitfields = 1140,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1141,            /* -mno-align-stringops */
  OPT_mno_default = 1142,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1143,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1144,                  /* -mno-push-args */
  OPT_mno_red_zone = 1145,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1146,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1147,             /* -mnop-fun-dllimport */
  OPT_momit_leaf_frame_pointer = 1148,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1149,                          /* -mpc32 */
  OPT_mpc64 = 1150,                          /* -mpc64 */
  OPT_mpc80 = 1151,                          /* -mpc80 */
  OPT_mpclmul = 1152,                        /* -mpclmul */
  OPT_mpe_aligned_commons = 1153,            /* -mpe-aligned-commons */
  OPT_mpopcnt = 1154,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1155,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1156,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1157,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1158,                        /* -mprfchw */
  OPT_mpush_args = 1159,                     /* -mpush-args */
  OPT_mrdrnd = 1160,                         /* -mrdrnd */
  OPT_mrdseed = 1161,                        /* -mrdseed */
  OPT_mrecip = 1162,                         /* -mrecip */
  OPT_mrecip_ = 1163,                        /* -mrecip= */
  OPT_mred_zone = 1164,                      /* -mred-zone */
  OPT_mregparm_ = 1165,                      /* -mregparm= */
  OPT_mrtd = 1166,                           /* -mrtd */
  OPT_mrtm = 1167,                           /* -mrtm */
  OPT_msahf = 1168,                          /* -msahf */
  OPT_msha = 1169,                           /* -msha */
  OPT_msoft_float = 1170,                    /* -msoft-float */
  OPT_msse = 1171,                           /* -msse */
  OPT_msse2 = 1172,                          /* -msse2 */
  OPT_msse2avx = 1173,                       /* -msse2avx */
  OPT_msse3 = 1174,                          /* -msse3 */
  OPT_msse4 = 1175,                          /* -msse4 */
  OPT_msse4_1 = 1176,                        /* -msse4.1 */
  OPT_msse4_2 = 1177,                        /* -msse4.2 */
  OPT_msse4a = 1178,                         /* -msse4a */
  /* OPT_msse5 = 1179, */                    /* -msse5 */
  OPT_msseregparm = 1180,                    /* -msseregparm */
  OPT_mssse3 = 1181,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1182,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1183,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1184,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1185,            /* -mstringop-strategy= */
  OPT_mtbm = 1186,                           /* -mtbm */
  OPT_mthreads = 1187,                       /* -mthreads */
  OPT_mtls_dialect_ = 1188,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1189,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1190,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1191,                         /* -mtune= */
  OPT_municode = 1192,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1193,          /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 1194,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1195,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1196,                    /* -mvzeroupper */
  OPT_mwin32 = 1197,                         /* -mwin32 */
  OPT_mwindows = 1198,                       /* -mwindows */
  OPT_mx32 = 1199,                           /* -mx32 */
  OPT_mxop = 1200,                           /* -mxop */
  OPT_mxsave = 1201,                         /* -mxsave */
  OPT_mxsaveopt = 1202,                      /* -mxsaveopt */
  OPT_n = 1203,                              /* -n */
  OPT_no_canonical_prefixes = 1204,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1205,              /* -no-integrated-cpp */
  OPT_no_pthread = 1206,                     /* -no-pthread */
  ...
  OPT_static_libgcj = 1248,                  /* -static-libgcj */
  ...
  OPT_time = 1292,                           /* -time */
  OPT_time_ = 1293,                          /* -time= */
  OPT_traditional = 1294,                    /* -traditional */
  OPT_traditional_cpp = 1295,                /* -traditional-cpp */
  OPT_trigraphs = 1296,                      /* -trigraphs */
  OPT_u = 1297,                              /* -u */
  OPT_undef = 1298,                          /* -undef */
  OPT_v = 1299,                              /* -v */
  OPT_version = 1300,                        /* -version */
  OPT_w = 1301,                              /* -w */
  OPT_wrapper = 1302,                        /* -wrapper */
  OPT_x = 1303,                              /* -x */
  OPT_z = 1304,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
